...
public class Context {
	public static void showContext() {
		Saisie.pressEnter("Dès qu'un message vous sera affiché vous pourrez le passer en appuyant sur ENTER et ce durant toute votre épopée.", true);
		
		if(Saisie.pressEnterToStartAndQToQuit("Appuyez sur S si vous connaissez l'histoire de notre Royaume, ou sur ENTER sinon : ", true, "s")) {
