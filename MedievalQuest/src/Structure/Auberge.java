...
public class Auberge implements IEvenement{
	...
	public static void dormirAuberge(Personnage p) {
		...
		if(tmp == 1) {
			...
			System.out.println("\nVous vous ï¿½tes fait dï¿½pouiller !");
			System.out.println("Vous perdez 1/3 de votre argent");
			
		}
		
		
		Saisie.pressEnter("\nVous avez gagnï¿½ 20 points de vie!\n", false);
	...
	public static void pillerAuberge(Personnage p) {
		...
		if(tmp == 2 || tmp ==0) {
			...
			System.out.println("\nVous avez trouvï¿½ un bouclier en bois !");
			Saisie.pressEnter("Vous avez gagnï¿½ 5 points de dï¿½fense\n", false);
		}
	}
